export const providers = {
  ...
  clickmeter: { group: 1, env: 'CLICKMETER_API_KEY', baseUrl: 'https://apiv2.clickmeter.com', purpose: 'Tracking de enlaces y conversiones' },
  ...
  apitemplate: { group: 4, env: 'APITEMPLATE_API_KEY', baseUrl: 'https://rest.apitemplate.io/v2', purpose: 'Generación de imágenes/PDF desde plantillas' },
  photoroom: { group: 4, env: 'PHOTOROOM_API_KEY', baseUrl: 'https://sdk.photoroom.com', purpose: 'Edición y eliminación de fondos' },
  ...
  buildpdf: { group: 5, env: 'BUILDPDF_API_KEY', baseUrl: 'https://api.buildpdf.com', purpose: 'Generación de PDFs' },
  carvector: { group: 6, env: 'CARVECTOR_API_KEY', baseUrl: 'https://api.carvector.com', purpose: 'Datos y especificaciones de vehículos' },
  ...
  ayrshare: { group: 8, env: 'AYRSHARE_API_KEY', baseUrl: 'https://api.ayrshare.com/api', purpose: 'Publicación y analítica social' },
  postlake: { group: 8, env: 'POSTLAKE_API_KEY', baseUrl: 'https://api.postlake.ai', purpose: 'Automatización de contenido social' },
  ...
  tripadvisor: { group: 9, env: 'TRIPADVISOR_API_KEY', baseUrl: 'https://api.content.tripadvisor.com/api/v1', purpose: 'Lugares, hoteles, restaurantes y turismo' },
